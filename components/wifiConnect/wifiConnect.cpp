...
#define SMARTCONFIGTIMEOUT	(5*60) // seconds to wait smartConfig, before switching to previous network
#define CONNECTRETRIES 		3 // before switching to smartconfig
...
void  wifiConnect(TaskHandle_t * p) {
	xTaskCreate(wifiConnectTask, "wifiConnectTask", 4096, NULL, 3, p);
}
